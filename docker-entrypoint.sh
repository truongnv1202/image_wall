...
if [ "$(id -u)" = 0 ]; then
  ...
  chown -R nextjs:nodejs /app/data /app/public/uploads /app/public/generated /app/public 2>/dev/null || true
  chmod -R 0777 /app/data /app/public/uploads /app/public/generated
  exec gosu nextjs "$0" "$@"
fi
